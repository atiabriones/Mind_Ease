  ...
  useEffect(() => {
    ...
    if (savedUser) {
      try {
        ...
        // 2. Set the name from your database field 'FullName' (returned as 'name')
    ...
    <>
        ...
        <div className="flex items-center gap-6">
          ...
          >
            ...
            <div className="w-10 h-10 rounded-full border-2 border-white shadow-sm overflow-hidden bg-slate-100">
              <img 
                src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${adminName}&backgroundColor=b6e3f4`} 
                alt="profile" 
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-md rounded-[2.5rem] p-10 shadow-2xl text-center border border-gray-100 animate-in fade-in zoom-in duration-200">
            ...
            <h2 className="text-xl font-black text-[#2d3748] mb-2">
              Are you sure you want to log out, {adminName}?
            </h2>
